<?php
// Fonction qui retourne une clé API pour un vendeur donné
function getAPIKey($vendeur)
{
    // Vérifie si le nom du vendeur est dans la liste autorisée
    if (in_array($vendeur, array(
        ...
        // Si le vendeur est valide, retourne une clé générée depuis le hash MD5 du nom (sous-chaîne de 15 caractères à partir du 2e caractère)
        return substr(md5($vendeur), 1, 15);
    }

    // Si le vendeur n'est pas dans la liste autorisée, retourne une clé par défaut
    return "zzzz";
}
?>
